...
```sh
git clone https://github.com/samir-adh/nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/samir-adh/nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/samir-adh/nvim.git "${env:LOCALAPPDATA}\nvim"
```
...
- [ ] Enhance split tab support
- [ ] Add auto docstring with `neogen` plugin
